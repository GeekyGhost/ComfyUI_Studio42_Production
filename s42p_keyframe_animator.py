"""
S42 Production Suite â€” Keyframe Animator Node
=============================================
...
Examples:
  position_x: "0:960, 24:200, 48:960"          â† ping-pong across screen
  opacity:    "0:0.0, 8:1.0, 40:1.0, 48:0.0"  â† fade in, hold, fade out
  scale_x:    "0:1.0, 12:1.5:ease_out, 48:1.0" â† bounce scale with custom ease
  rotation:   "0:0, 48:360"                    â† full spin over 48 frames
...
Output is a standard IMAGE batch â€” connect directly to
            ...
            "required": {
                ...
                "layer_image": ("IMAGE", {
                    "tooltip": ("The image/graphic to animate over the background. "
                                "Can be a single frame or a batch â€” if batch, frames cycle. "
                ...
                "opacity": ("STRING", {
                    ...
                    "tooltip": (f"Opacity keyframes. 0.0 = fully transparent. 1.0 = fully opaque.\n"
                                f"Tip: fade in with '0:0.0, 8:1.0' â€” fade out with '40:1.0, 48:0.0'.\n{kf_tip}")
                }),
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "S42PKeyframeAnimator": "ðŸŽžï¸ S42P Keyframe Animator",
}

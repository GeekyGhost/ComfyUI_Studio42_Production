"""
S42 Production Suite — Node Registration v3.0
===============================================
...
AUDIO NODES (9):
  ...
  s42p_songwriter         → S42P Songwriter          [FIXED v4.1 — think-block stripping]
  s42p_eq_presets         → S42P EQ Preset Loader

AUDIO REACTIVE NODES (2):
  s42p_audio_reactive_fx  → S42P Audio Reactive FX   [NEW v3.0 — refactored from Studio42 ref]
  s42p_matrix_fx          → S42P Matrix Rain FX       [NEW v3.0]
...
VIDEO / COMPOSITE NODES (6):
  ...
  s42p_background_remover → S42P Background Remover   [NEW v3.0 — ported from 24oiduts]
  s42p_layer_composer     → S42P Layer Composer       [NEW v3.0 — ported from 24oiduts]
...
print(f"\n{'─'*60}")
print(f"  S42 Production Suite  v3.0.0")

...
def _format_report(d_a: dict, d_b: Optional[dict] = None,
    ...
    def metrics_block(d):
        ...
        L.extend([
            ...
            f'  Crest Factor      {d["crest_factor"]:.2f}  (σ/s={d["crest_std"]:.2f})',
            ...
            f'  Spec Centroid     {d["sc_mean"]:.0f} Hz  (σ={d["sc_std"]:.0f})',
    ...
    if d_b is not None:
        ...
        L.append(f'  {"OVERALL":<20s}  A:{oa:4.1f}  B:{ob:4.1f}  Δ{dov:+.1f}  → {win}')
...
CATEGORY = "S42 Production Suite 🔬 Analysis"
